...
gsap.to(".page1 .video-section video",{
    ...
    onStart:()=>{
        document.querySelector(".page1 .video-section video").play()
    }
})
gsap.to(".page1",{
    scrollTrigger:{
...
function canvas(){
    const canvas = document.querySelector(".page7-canvas>canvas");
...
function canvas1(){
  const canvas = document.querySelector(".page17-canvas>canvas");
const context = canvas.getContext("2d");
